...
namespace ProceduralLevelGenerator.Unity.Editor.LevelGenerators
{
    ...
    public class DungeonGeneratorInspector : UnityEditor.Editor 
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // PRO
            EditorGUILayout.PropertyField(serializedObject.FindProperty(nameof(DungeonGeneratorBase.InputType)));
            switch (levelGenerator.InputType)
            {
                case DungeonGeneratorInputType.CustomInput:
                    EditorGUILayout.PropertyField(serializedObject.FindProperty(nameof(DungeonGeneratorBase.CustomInputTask)));
                    break;
